...
import { z } from 'zod';
import { PerformWebAnalysisOutputSchema } from '@/ai/flows/perform-web-analysis';
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className={`font-medium ${result.realTimeFactCheck ? 'text-green-500' : 'text-destructive'}`}>
      ...
      {result.currentInformation && result.currentInformation.length > 0 ? (
        ...
        <div className="space-y-2">
          <h3 className="font-semibold text-lg flex items-center gap-2">
            <AlertTriangle className="h-5 w-5 text-yellow-500" /> No Current Information
          </h3>
