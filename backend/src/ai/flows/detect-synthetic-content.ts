...
const DetectSyntheticContentOutputSchema = z.object({
  ...
  confidenceScore:
    ...
    .max(100)
    .describe(
      'A confidence score (0-100) for the synthetic content assessment. Higher means more certain.'
    ),
  analysis:
    z.string().describe(
      'A detailed analysis explaining the findings, including any synthetic markers or indicators.'
    ),
...
export async function detectSyntheticContent(
  input: DetectSyntheticContentInput
): Promise<DetectSyntheticContentOutput> {
