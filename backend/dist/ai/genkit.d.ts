...
export declare const getPreferredTextModel: () => import("@google-cloud/vertexai").GenerativeModel;
export declare const getPreferredVisionModel: () => import("@google-cloud/vertexai").GenerativeModel;
