...
const AnalyzeContentOutputSchema = z.object({
    misinformationPotential: z
        .number()
        .describe('A score from 0 to 1 indicating the potential for misinformation. Higher values indicate higher potential.'),
...
export async function analyzeContentForMisinformation(input) {
...
//# sourceMappingURL=analyze-content-for-misinformation.js.map