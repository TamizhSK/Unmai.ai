...
async function analyzeImageContentAndFactCheck(imageData, ocrText) {
    ...
    const factualClaims = responseText.includes('Claims:')
...
async function reverseImageSearch(imageData) {
...
export async function analyzeImageContent(input) {
    try {
        ...
        const reverseSearch = await reverseImageSearch(input.imageData);
